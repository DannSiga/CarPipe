            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="card card-outline card-success">
                        ...
                        $query_clientes = $pdo->prepare("SELECT * FROM clientes WHERE idCliente = '$id_cliente_get' AND estado = '1'  ");
                        $query_clientes->execute();
                        $datos_clientes = $query_clientes->fetchAll(PDO::FETCH_ASSOC);
                        foreach($datos_clientes as $datos_cliente){
                            $id_cliente = $datos_cliente['idCliente'];
                            $nombre_cliente = $datos_cliente['nombre'];
                            $nit_ci_cliente = $datos_cliente['telefono'];
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="telefono" class="form-control" value="<?php echo $nit_ci_cliente;?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
...
<script>
    $('#btn_actualizar_cliente').click(function () {
        ...
        if(nombre_cliente == ""){
            ...
            alert('Debe de llenar el campo Telefono del cliente');
            $('#telefono').focus();
        }else if(placa_auto == ""){
            ...
            $.get(url,{nombre_cliente:nombre_cliente,telefono:telefono,placa_auto:placa_auto,id_cliente:id_cliente},function (datos) {
