...
$sentencia = $pdo->prepare('INSERT INTO tb_comprobante(nombre, telefono, cubibulo, fecha_ingreso, hora_ingreso, responsable, observ, fyh_crea, estado)
                                             VALUES(:nombre, :telefono, :cubibulo,:fecha_ingreso, :hora_ingreso, :responsable, :observ, :fyh_crea, :estado)');
